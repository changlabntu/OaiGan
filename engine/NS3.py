...
class GAN(BaseModel):
    ...
    def backward_g(self, inputs):
        ...
        # L1(X1, X)
        loss_g = self.add_loss_L1(a=self.imgX1, b=self.oriX, loss=loss_g, coeff=self.hparams.lamb * 0.01)
    ...
    def backward_d(self, inputs):
        loss_d = 0
        # ADV(X0)-
        loss_d = self.add_loss_adv(a=self.imgX0, b=None, net_d=self.net_d, loss=loss_d, coeff=0.5, truth=False, stacked=False)
