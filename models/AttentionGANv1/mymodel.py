...
class Generator(nn.Module):
    def __init__(self, netG, input_nc=3, output_nc=4, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6):
        assert(n_blocks >= 0)
        ...
        for i in range(n_blocks):
            encoder += [ResnetBlock(ngf * mult, norm_layer=norm_layer, use_dropout=use_dropout)]
...
if __name__ == '__main__':
    model = Generator(input_nc=3, output_nc=4, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6)